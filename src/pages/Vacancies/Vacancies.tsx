        ...
        <div>
          <div className="Vacancies-leftSidebar-button-title">
            ...
            <div className="Vacancies-title-block">
              <p>
                Наша команда – это более 400 человек-профессионалов своего дела.{' '}
                <p></p>
                Среди них есть те, кто работает с нами уже много лет, и те, кто
                пришел совсем недавно. <p></p>И всех их объединяет желание
                работать в стабильном проверенным временем бизнесе, который
                постоянно растет и <p></p> развивается, открывая для себя и для
                своих клиентов новые горизонты и возможности. <p></p>{' '}
              ...
              <div className="Vacancies-button-block-div">
                ...
                <div className="Vacancies-button-block">
                  <Button className="Vacancies-button">ОТПРАВИТЬ РЕЗЮМЕ</Button>
                </div>
              </div>
