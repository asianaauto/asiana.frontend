          ...
          <div className="DeliveryInRussia-leftSidebar-title">
            ...
            <div className="DeliveryInRussia-title-block">
              ...
              <div className="DeliveryInRussia-paragraph">
                <p>
                  Пн-пт с 9 00 до 18 00 <p></p>
                  Сб с 9 00 до 17 00 <p></p>
                  Вс - выходной
                </p>
              </div>
              ...
              <p
                ...
                оптовым отделом по телефону или электронной <p></p> почте.
              </p>

              <p className="DeliveryInRussia-paragraph">
                Компания «Кореана» с 2001 года осуществляет оптовые поставки
                запасных частей по всем регионам Российской <p></p> федерации.{' '}
                <p></p>
                Вам необходимо сделать выгодную оптовую закупку автомобильных
                ...
                являетесь жителем Москвы, или <p></p> Санкт-Петербурга и
                работаете на рынке других городов Российской Федерации?..{' '}
                <p></p>
                Предлагая оптовую реализацию запасных элементов для самых
                востребованных корейских автомобилей, мы с радостью <p></p>{' '}
                поможем Вам сделать выгодный оперативный заказ.
              </p>
              ...
              <p className="DeliveryInRussia-paragraph">
                ...
                Доставка по регионам осуществляется различными <p></p>{' '}
                транспортными компаниями, такими как ПЭК, Байкал, УТС и другими,
              ...
              <div className="DeliveryInRussia-paragraph-div">
                <div className="DeliveryInRussia-border">
                  ...
                  <h4 className="DeliveryInRussia-title-h2">
                    ...
                    доставку по России при сумме заказа от <p></p> 10 000
                    рублей.
                  </h4>
                </div>
              </div>
              ...
              <p className="DeliveryInRussia-paragraph-p">
                ...
                максимально выгодных для Вас условиях. «Кореана» <p></p>{' '}
                занимается поставкой запчастей для таких брендов, как:
              </p>
              ...
              <p className="DeliveryInRussia-last-paragraph">
                ...
                покупателям – сделают Вашу покупку еще более выгодной и <p></p>{' '}
                ...
                консультантам, которые всегда с радостью <p></p> ответят на все
                Ваши вопросы.
              </p>
            </div>
          </div>
